                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: DefaultTextStyle(
                      style: const TextStyle(color: Color(0xFF1E293B), fontFamily: 'Courier'),
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              Icon(Icons.account_balance_wallet_rounded, size: 40, color: const Color(0xFF00D09E).withOpacity(0.8)),
                            ],
                          ),
                          ...
                          const Row(
                            ...
                            children: [
                              Expanded(
                                flex: 3, 
                                child: Text('Tên sản phẩm / Dịch vụ', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                              ),
                              Expanded(
                                child: Text('SL', textAlign: TextAlign.right, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                              ),
                              Expanded(
                                flex: 2, 
                                child: Text('Thành tiền', textAlign: TextAlign.right, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Text('1', textAlign: TextAlign.right, style: TextStyle(fontSize: 12)),
                              ),
                              Expanded(
                                flex: 2, 
                                child: Text(
                          ...
                          Row(
                            children: [
                              const Expanded(
                                child: Text('Cộng tiền hàng (Subtotal):', style: TextStyle(fontSize: 12)),
                              ),
                              Text(
                                currencyFormatter.format(invoice.subtotal), 
                          ...
                          Row(
                            children: [
                              Expanded(
                                child: Text('Thuế suất GTGT (VAT): ${invoice.vatRate}%', style: const TextStyle(fontSize: 12)),
                              ),
                              Text(
