    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          var filteredTxs = allTxs.where((tx) => tx.status == TransactionStatus.confirmed).toList();
          
          if (currentRole == UserRole.expenseAccountant) {
            filteredTxs = filteredTxs.where((tx) => tx.type == TransactionType.expense).toList();
          } else if (currentRole == UserRole.revenueAccountant) {
            filteredTxs = filteredTxs.where((tx) => tx.type == TransactionType.income).toList();
          }
          ...
          final double expensePercentage = (expenseSum / budgetLimit).clamp(0.0, 1.0);
                            ...
                            children: [
                              Text(
                                ...
                                style: const TextStyle(
                                  ...
                                  color: Color(0xFF1E293B), // Professional dark slate/black
                                  letterSpacing: -0.5,
                                ),
                              ),
                                ...
                                TextSpan(
                                  children: [
                                    TextSpan(
                                      ...
                                      style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                        color: Color(0xFF064E3B), // Dark green highlight for readability on green background
                                      ),
                                    ),
                                    const TextSpan(
                                      text: ' • Buổi sáng tốt lành',
                                      style: TextStyle(
                                        color: Color(0xFF334155), // Muted dark slate
                                      ),
                                    ),
                                  ],
                                ),
                            ...
                            FittedBox(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 28,
                                  fontWeight: FontWeight.bold,
                                  color: totalBalance >= 0 ? const Color(0xFFADF8D8) : const Color(0xFFFFC0C0),
                                ),
                              ),
                            ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          const Icon(Icons.arrow_upward_rounded, size: 14, color: Color(0xFF86EFAC)),
                                      ...
                                      FittedBox(
                                        ...
                                        child: Text(
                                          ...
                                          style: const TextStyle(
                                            fontSize: 18,
                                            fontWeight: FontWeight.bold,
                                            color: Color(0xFFADF8D8), // Light green for income
                                          ),
                                        ),
                                      ),
                                    ],
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          const Icon(Icons.arrow_downward_rounded, size: 14, color: Color(0xFFFCA5A5)),
                                          const SizedBox(width: 4),
                                          Text(
                                            'Tổng chi',
                                            style: TextStyle(
                                      ...
                                      FittedBox(
                                        ...
                                        child: Text(
                                          ...
                                          style: const TextStyle(
                                            fontSize: 18,
                                            fontWeight: FontWeight.bold,
                                            color: Color(0xFFFFC0C0), // Light red/rose for expenses
                                          ),
                                        ),
                                      ),
                                    ],
                ...
                sliver: SliverList(
                  delegate: SliverChildListDelegate([
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4),
                                Text(
                                  currencyFormatter.format(4000000), // static representation for UI layout
                                  style: TextStyle(
                                    color: isDark ? const Color(0xFF00D09E) : const Color(0xFF059669),
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16,
                                  ),
                                ),
                                ...
                                Text(
                                  ...
                                  style: const TextStyle(
                                    color: Color(0xFFE11D48), // Rose/red for negative expenses
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16,
                                  ),
                                ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: isDark ? const Color(0xFF0C2C1F) : const Color(0xFFE8F6F1),
                        borderRadius: BorderRadius.circular(16),
                      ),
                      child: Row(
                        children: [
                    ...
                    if (filteredTxs.isEmpty)
                      ...
                      ...filteredTxs.map((tx) {
                        ...
                        Color iconBgColor = isIncome ? const Color(0xFFE0F2FE) : const Color(0xFFFEE2E2);
                        ...
                        } else if (catName.contains('Mặt bằng') || catName.contains('Điện nước')) {
                          leadingIcon = Icons.home_work_rounded;
                          iconBgColor = const Color(0xFFEEF2FF); // indigo
                          iconColor = const Color(0xFF4F46E5);
                        } else if (catName.contains('bán hàng') || catName.contains('dịch vụ')) {
                          leadingIcon = Icons.storefront_rounded;
                          iconBgColor = const Color(0xFFECFDF5); // light green
                          iconColor = const Color(0xFF059669);
                        } else if (catName.contains('Mua hàng') || catName.contains('Vận hành')) {
